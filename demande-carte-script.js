...
class FormValidator {
    ...
    initValidation() {
        ...
        if (!form) {
            console.error('❌ Formulaire carte-form non trouvé');
            return;
        }
    ...
    validateField(field) {
        ...
        switch (fieldName) {
            ...
            case 'type-carte':
                if (!value) {
                    isValid = false;
                    errorMessage = 'Veuillez sélectionner un type de carte';
                }
                break;
            ...
            case 'plafond-journalier':
                if (value && parseFloat(value) < 0) {
                    isValid = false;
                    errorMessage = 'Le plafond ne peut pas être négatif';
                }
                break;

            case 'plafond-mensuel':
                if (value && parseFloat(value) < 0) {
                    isValid = false;
                    errorMessage = 'Le plafond ne peut pas être négatif';
                }
    ...
    showSuccessMessage() {
        ...
        overlay.innerHTML = `
            <div class="success-message">
                ...
                <p>Votre demande de carte bancaire a été transmise à notre équipe. Nous vous répondrons dans les plus brefs délais.</p>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Initialisation de la page demande-carte');
