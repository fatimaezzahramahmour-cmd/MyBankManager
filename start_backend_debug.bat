@echo off
echo ========================================
echo   Démarrage MyBankManager Backend Debug
echo ========================================
echo.
...
echo [3/3] Démarrage du serveur Spring Boot avec debug...
echo.
...
cd Mybankmanager
call mvnw.cmd spring-boot:run -Dspring-boot.run.jvmArguments="-Ddebug=true"
